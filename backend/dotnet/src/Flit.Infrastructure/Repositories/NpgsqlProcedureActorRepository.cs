...
public sealed class NpgsqlProcedureActorRepository(FlitDbContext db) : IProcedureActorRepository
{
    public async Task UpsertAsync(ProcedureActorEntry entry, CancellationToken ct = default)
    {
        ...
        cmd.CommandText = """
            ...
            ON CONFLICT (procedure_instance_id, edge_role) DO UPDATE SET
        ...
        {
            // Sin DDL o catálogo document_types ausente en entorno parcial.
        }
    }
        ...
        CancellationToken ct = default)
    {
        ...
        cmd.CommandText = """
            SELECT a.id, a.tenant_id, a.procedure_instance_id, a.edge_role, a.person_kind,
                   dt.code, a.document_number, a.full_name, a.created_by, a.updated_by
        ...
        try
        {
            ...
            {
                list.Add(new ProcedureActorEntry(
                    reader.GetGuid(0),
                    reader.GetGuid(1),
                    reader.GetGuid(2),
                    reader.GetString(3),
